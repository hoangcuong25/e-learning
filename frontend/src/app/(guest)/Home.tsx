    ...
    <div className="space-y-24 pb-20">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-10 py-24 md:py-32 flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1 space-y-8 text-center lg:text-left">
            ...
            >
              Tiếp cận nguồn tri thức tinh hoa từ các chuyên gia hàng đầu.{" "}
              <br className="hidden md:block" />
      ...
      <section className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-end justify-between gap-6 mb-12">
          ...
          <Link
            href="/courses"
            className="text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-indigo-600 transition-colors border-b-2 border-slate-100 pb-1"
          >
            Xem tất cả khóa học
          </Link>
        </div>
        ...
        {popularCourses.length === 0 ? (
          <div className="py-20 flex flex-col items-center justify-center bg-slate-50 rounded-[3rem] border-2 border-dashed border-slate-200">
            <p className="text-slate-400 font-bold italic">
              Dữ liệu khóa học đang được cập nhật...
            </p>
          </div>
        ) : (
          ...
          {[
            {
              icon: BookOpen,
              title: "Học linh hoạt",
              desc: "Học bất cứ lúc nào, mọi nơi chỉ với một kết nối Internet.",
            },
            {
              icon: Clock,
              title: "Tiết kiệm thời gian",
              desc: "Tối ưu lộ trình học tập, không cần di chuyển hay chờ đợi.",
            },
            {
              icon: GraduationCap,
              title: "Chứng chỉ uy tín",
              desc: "Chứng nhận giá trị, được công nhận bởi hàng ngàn nhà tuyển dụng.",
            },
          ].map((feature, i) => (
            <motion.div
              key={i}
      ...
      <section className="max-w-7xl mx-auto px-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            >
              <p className="text-4xl font-black text-indigo-600 group-hover:text-white transition-colors tracking-tighter mb-1">
                {item.value}
              </p>
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest group-hover:text-slate-500">
                {item.label}
              </p>
            </motion.div>
          ))}
        ...
        <div className="bg-slate-900 rounded-[4rem] p-12 md:p-20 flex flex-col lg:flex-row items-center justify-between gap-16 shadow-[0_48px_96px_-24px_rgba(0,0,0,0.5)] relative overflow-hidden group border border-slate-800">
          ...
          <div className="flex-1 space-y-8 relative z-10 text-center lg:text-left">
            ...
            <p className="text-slate-400 text-lg font-medium leading-relaxed max-w-lg mx-auto lg:mx-0">
              Trở thành một phần của hệ sinh thái EduSmart để kết nối với hàng
              triệu học viên và kiến tạo lộ trình sự nghiệp tương lai.
            </p>
